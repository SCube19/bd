...
insert into gracze values('da_Vinki', 'xxx', 'bot');
...
insert into gracze values('hide_on_bush', 'xxx', 'bot');
...
insert into gracze values('janusz_tracz', 'xxx', 'bot');
insert into gracze values('ksiadz_mateusz', 'xxx', 'bot');
insert into gracze values('travis_scott', 'xxx', 'bot');
insert into gracze values('hikamura', 'xxx', 'bot');
insert into gracze values('garry', 'xxx', 'bot');
insert into gracze values('barry', 'xxx', 'bot');
insert into gracze values('larry', 'xxx', 'bot');
insert into gracze values('mimuw_dropout', 'xxx', 'bot');
insert into gracze values('szpieg_polibudy', 'xxx', 'bot');
insert into gracze values('bid_daddy', 'xxx', 'bot');
insert into gracze values('joe_tata', 'xxx', 'bot');
insert into gracze values('biggus^dikkus', 'xxx', 'bot');
insert into gracze values('post-malone', 'xxx', 'bot');
insert into gracze values('mosty-palone', 'xxx', 'bot');
insert into gracze values('friz', 'xxx', 'bot');
insert into gracze values('monterek', 'xxx', 'bot');
insert into gracze values('sugondeez', 'xxx', 'bot');
insert into gracze values('dzieciwpiwnicy', 'xxx', 'bot');
insert into gracze values('nick:D', 'xxx', 'bot');
insert into gracze values('pink_guy', 'xxx', 'bot');
insert into gracze values('obunga', 'xxx', 'bot');
insert into gracze values('ligma', 'xxx', 'bot');
insert into gracze values('sugma', 'xxx', 'bot');
insert into gracze values('Kubv', 'xxx', 'bot');
insert into gracze values('kwiat_jabloni', 'xxx', 'bot');
insert into gracze values('polski_pingwin', 'xxx', 'bot');
insert into gracze values('jjoker', 'xxx', 'bot');
insert into gracze values('haco_temingway', 'xxx', 'bot');
insert into gracze values('Njuton_boi', 'xxx', 'bot');
insert into gracze values('chad_ajnsztajn', 'xxx', 'bot');
insert into gracze values('xxx_on_only-fans', 'xxx', 'bot');
insert into gracze values('Bella_z_delfina', 'xxx', 'bot');
insert into gracze values('xX-Shreks-xX', 'xxx', 'bot');
insert into gracze values('yandere_dev', 'xxx', 'bot');
